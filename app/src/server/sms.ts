...
// Normalisation E.164 : définie une seule fois dans `shared/phone`, avec le
// masque de saisie qui empêche d'écrire un numéro qu'elle rejetterait.
// Ré-exportée ici parce que tout le code serveur l'importe déjà de `./sms`.
export { toE164 };
